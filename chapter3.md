...
![&#x56FE;3.1](https://github.com/azl397985856/automate-everything/blob/master/illustrations/图3.1.png)
...
![&#x56FE;3.2](https://github.com/azl397985856/automate-everything/blob/master/illustrations/图3.2.png)

如果要实现以上功能，一个最简单的方法就是执行create-react-app xxx 之后去远端下载文件到本地。其实cra的思路就是这样的，我用一张图来表示cra的基本过程：

![&#x56FE;3.3](https://github.com/azl397985856/automate-everything/blob/master/illustrations/图3.3.png)
...
![&#x56FE;3.4](https://github.com/azl397985856/automate-everything/blob/master/illustrations/图3.4.png)
...
![&#x56FE;3.5](https://github.com/azl397985856/automate-everything/blob/master/illustrations/图3.5.png)
...
![&#x56FE;3.6](https://github.com/azl397985856/automate-everything/blob/master/illustrations/图3.6.png)
...
![&#x56FE;3.8](https://github.com/azl397985856/automate-everything/blob/master/illustrations/图3.8.png)

运行之后效果是这样的：

![&#x56FE;3.7](https://github.com/azl397985856/automate-everything/blob/master/illustrations/%20图3.7.png)

jxa提供了丰富的api供我们使用。详细可以查看脚本编辑器-文件-字典：

![&#x56FE;3.9](https://github.com/azl397985856/automate-everything/blob/master/illustrations/图3.9.png)

比如我要查看dash的api：

![&#x56FE;3.10](https://github.com/azl397985856/automate-everything/blob/master/illustrations/图3.10.png)
...
![&#x56FE;3.11](https://github.com/azl397985856/automate-everything/blob/master/illustrations/图3.11.png)
...
![&#x56FE;3.12](https://github.com/azl397985856/automate-everything/blob/master/illustrations/图3.12.png)
