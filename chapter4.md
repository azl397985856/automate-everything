...
#### 图片优化的具体实践
有了上面的理论之后，我们需要将理论具体运用在实践上。 我们平时开发的时候会有缩略图的需求，如果你将原始图片加载过来通过css控制显示的话，你会发现你会加载一个非常大的图片，然而本身应该很小才对。那么如果我们可以控制只下载我们需要缩略显示的部分就好了。`https://test.imgix.net/some_file?w=395&h=96&crop=faces`
## 总结
